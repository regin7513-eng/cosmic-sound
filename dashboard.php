...
<body>
    <div class="dashboard">
        ...
        <main class="main-content">
            ...
            <div id="section-search" class="section">
                <div class="mobile-search-header" id="mobile-search-header">
                    <div class="mobile-search-box" id="mobile-search-box">
                        ...
                        <input type="text" id="mobile-search-input" class="mobile-search-input" placeholder="What do you want to listen to?" oninput="onMobileSearchInput(this.value)" onfocus="onSearchFocus()">
                    </div>
                    <button class="mobile-search-cancel" id="mobile-search-cancel" onclick="cancelSearch()" style="display:none">Batal</button>
                </div>
    ...
    <div class="context-menu" id="context-menu">
        <button class="context-menu-item" id="ctx-add-fav">
            <svg id="ctx-fav-icon" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M20.84 4.61a5.5 5.5 0 0 0-7.78 0L12 5.67l-1.06-1.06a5.5 5.5 0 0 0-7.78 7.78l1.06 1.06L12 21.23l7.78-7.78 1.06-1.06a5.5 5.5 0 0 0 0-7.78z"/></svg>
            <span id="ctx-fav-text">Add to Favorites</span>
        </button>
        <button class="context-menu-item" id="ctx-add-playlist">
            <svg id="ctx-pl-icon" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"><line x1="12" y1="5" x2="12" y2="19"/><line x1="5" y1="12" x2="19" y2="12"/></svg>
            <span id="ctx-pl-text">Add to Playlist</span>
        </button>
    </div>
